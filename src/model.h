...
public:
	...
	double compute_energy(pagerank page); 
	double compute_likelihood();
	double compute_objective(double factor, pagerank page);
	void smooth_distribution(double factor, pagerank page); //smooth doc-topic distribution and alpha vector for each doc
	void smooth_alpha(double factor, pagerank page);
};
